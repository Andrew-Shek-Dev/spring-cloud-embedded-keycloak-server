package io.tecky.server.keycloak;
...
import io.tecky.server.keycloak.providers.SimplePlatformProvider;
...
public class Config {
	...
	//ServletRegistrationBean -> jersey if Spring Boot 3.0 -> no luck
	@Bean
	ServletRegistrationBean<HttpServlet30Dispatcher> keycloakJaxRsApplication() throws Exception {
		...
		servlet.addInitParameter("javax.ws.rs.Application", App.class.getName()); //OK
		servlet.addInitParameter(ResteasyContextParameters.RESTEASY_SERVLET_MAPPING_PREFIX,
				properties.contextPath());
		servlet.addInitParameter(ResteasyContextParameters.RESTEASY_USE_CONTAINER_FORM_PARAMS, "true");
		servlet.addUrlMappings(properties.contextPath() + "/*"); //OK
		servlet.setLoadOnStartup(1); //OK
		servlet.setAsyncSupported(true);//OK
